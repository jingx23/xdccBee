...
public abstract class AbstractTableColumnSorterListener implements Listener {
	...
	public AbstractTableColumnSorterListener(TableViewer tblViewer, boolean isMultipleColumnSort){
	...
	public void handleEvent(Event e) {
        ...
        if(! isMultipleColumnSort ) clearSort();
	...
	protected abstract AbstractTableColumnSorter getTableColumnSorterAbstract(LinkedHashMap<String, Integer> mapColumnsToSort);
