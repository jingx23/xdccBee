...
public class AutoResizeTableLayout extends TableLayout implements ControlListener {
	...
	/* Beispiel:
	 * After defining your columns
	 * AutoResizeTableLayout autoTableLayout = new AutoResizeTableLayout(table);
	 * autoTableLayout.addColumnData(new ColumnPixelData(0)); //Resize based on content
	 * autoTableLayout.addColumnData(new ColumnWeightData(1)); //Get 50% of space
	 * autoTableLayout.addColumnData(new ColumnWeightData(1)); //Get 50% of space
	 * autoTableLayout.addColumnData(new ColumnPixelData(100)); //Always 100 pixels
	 */
